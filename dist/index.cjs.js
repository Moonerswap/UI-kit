...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { title: "#000000", navBar: "#FFFFFF", sideBar: "#FFFFFF", heading: "#7f00ff", background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "linear-gradient(to right, #e0eafc, #cfdef3)", tertiary: "#EFF4F5", text: "linear-gradient(to right, #7f00ff, #e100ff)", textDisabled: "#BDC2C4", textSubtle: "#000", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { title: "#FFFFFF", navBar: "#27262c", sideBar: "#27262c", secondary: "#9A6AFF", background: "#000000", heading: "linear-gradient(to right, #7f00ff, #e100ff)", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
