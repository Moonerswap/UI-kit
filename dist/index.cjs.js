...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React__default['default'].createElement("image", { width: "26", height: "26", href: isDark ? '/images/logoTextDark.svg' : '/images/logoTextLight.svg' })));
};
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement(Icon$U, { width: "32px", height: "32px" }));
    if (isExternal) {
...
styled__default['default'].a(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n\ncursor:pointer;\npadding: 0 1rem 0 1rem;\ncolor: ", ";\nfont-size: 1.3rem;\npadding: 1rem;  \n \n  "], ["\n\ncursor:pointer;\npadding: 0 1rem 0 1rem;\ncolor: ", ";\nfont-size: 1.3rem;\npadding: 1rem;  \n \n  "])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var T = styled__default['default'](Text)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  cursor: pointer;\n  @-webkit-keyframes hvr-hang {\n    0% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    50% {\n      -webkit-transform: translateY(4px);\n      transform: translateY(4px);\n    }\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @keyframes hvr-hang {\n    0% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    50% {\n      -webkit-transform: translateY(4px);\n      transform: translateY(4px);\n    }\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @-webkit-keyframes hvr-hang-sink {\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @keyframes hvr-hang-sink {\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    \n    \n    \n      -webkit-transform: perspective(1px) translateZ(0);\n      transform: perspective(1px) translateZ(0);\n      box-shadow: 0 0 1px rgba(0, 0, 0, 0);\n      position: relative;\n      overflow: hidden;\n    \n    &:before {\n      content: \"\";\n      position: absolute;\n      z-index: -1;\n      left: 0;\n      right: 100%;\n      top: 0;\n      background: linear-gradient(to right, #bc4e9c, #f80759);\n      height: 4px;\n      -webkit-transition-property: right;\n      transition-property: right;\n      -webkit-transition-duration: 0.3s;\n      transition-duration: 0.3s;\n      -webkit-transition-timing-function: ease-out;\n      transition-timing-function: ease-out;\n    }\n    &:hover:before, &:focus:before, &:active:before {\n      right: 0;\n    }\n    \n    \n    \n    -webkit-transform: perspective(1px) translateZ(0);\n        transform: perspective(1px) translateZ(0);\n        box-shadow: 0 0 1px rgba(0, 0, 0, 0);\n        -webkit-transition-duration: 0.3s;\n        transition-duration: 0.3s;\n        -webkit-transition-property: transform;\n        transition-property: transform;\n      \n      &:hover, &:focus, &:active {\n        -webkit-transform: translateX(8px);\n        transform: translateX(8px);\n      }\n    \n"], ["\n  cursor: pointer;\n  @-webkit-keyframes hvr-hang {\n    0% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    50% {\n      -webkit-transform: translateY(4px);\n      transform: translateY(4px);\n    }\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @keyframes hvr-hang {\n    0% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    50% {\n      -webkit-transform: translateY(4px);\n      transform: translateY(4px);\n    }\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @-webkit-keyframes hvr-hang-sink {\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @keyframes hvr-hang-sink {\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    \n    \n    \n      -webkit-transform: perspective(1px) translateZ(0);\n      transform: perspective(1px) translateZ(0);\n      box-shadow: 0 0 1px rgba(0, 0, 0, 0);\n      position: relative;\n      overflow: hidden;\n    \n    &:before {\n      content: \"\";\n      position: absolute;\n      z-index: -1;\n      left: 0;\n      right: 100%;\n      top: 0;\n      background: linear-gradient(to right, #bc4e9c, #f80759);\n      height: 4px;\n      -webkit-transition-property: right;\n      transition-property: right;\n      -webkit-transition-duration: 0.3s;\n      transition-duration: 0.3s;\n      -webkit-transition-timing-function: ease-out;\n      transition-timing-function: ease-out;\n    }\n    &:hover:before, &:focus:before, &:active:before {\n      right: 0;\n    }\n    \n    \n    \n    -webkit-transform: perspective(1px) translateZ(0);\n        transform: perspective(1px) translateZ(0);\n        box-shadow: 0 0 1px rgba(0, 0, 0, 0);\n        -webkit-transition-duration: 0.3s;\n        transition-duration: 0.3s;\n        -webkit-transition-property: transform;\n        transition-property: transform;\n      \n      &:hover, &:focus, &:active {\n        -webkit-transform: translateX(8px);\n        transform: translateX(8px);\n      }\n    \n"])));
var Price = styled__default['default'].div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  \n"], ["\n  \n"])));
var PriceLink = styled__default['default'].a(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var UpdatedFlex = styled__default['default'](Flex)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  width: 20rem;\n  justify-content: space-between;\n  display: none;\n  margin-left: 0rem;\n  ", " {\n    display: flex;\n    margin-left: 2rem;\n  }\n"], ["\n  width: 20rem;\n  justify-content: space-between;\n  display: none;\n  margin-left: 0rem;\n  ", " {\n    display: flex;\n    margin-left: 2rem;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var UpdatedFlex2 = styled__default['default'](Flex)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  justify-content: space-between;\n  display: none;\n  margin-left: 0rem;\n  ", " {\n    display: flex;\n    margin-left: 2rem;\n  }\n"], ["\n  justify-content: space-between;\n  display: none;\n  margin-left: 0rem;\n  ", " {\n    display: flex;\n    margin-left: 2rem;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Flex, null,
                ...
                React__default['default'].createElement(UpdatedFlex, { alignItems: "center" },
                    React__default['default'].createElement(Dropdown, { target: React__default['default'].createElement(T, null, "Trade") },
                        React__default['default'].createElement(T, null, "Exchange"),
                        React__default['default'].createElement(T, null, "Liquidity")),
                    React__default['default'].createElement(T, null, "Farms"),
                    React__default['default'].createElement(T, null, "Pools"),
                    React__default['default'].createElement(T, null, "NFT"),
                    React__default['default'].createElement(Dropdown, { target: React__default['default'].createElement(T, null,
                            React__default['default'].createElement(Icon$M, null)) },
                        React__default['default'].createElement(T, null, "Bird Software"),
                        React__default['default'].createElement(T, null, "Solution")))),
            React__default['default'].createElement(Flex, { alignItems: "center" },
                React__default['default'].createElement(Button, { style: { padding: "0rem 0.8rem", marginRight: "1rem" }, variant: "text", onClick: function () { return toggleTheme(!isDark); } },
                    React__default['default'].createElement(Flex, { alignItems: "center" },
                        ...
                        React__default['default'].createElement(Icon$L, { color: isDark ? "text" : "textDisabled", width: "24px" }))),
                React__default['default'].createElement(UpdatedFlex2, { alignItems: "center" },
                    React__default['default'].createElement(Price, null, cakePriceUsd ? (React__default['default'].createElement(PriceLink, null,
                        "     ",
                    ...
                    React__default['default'].createElement(Dropdown, { target: React__default['default'].createElement(Button, { style: { padding: "0 0.5rem", margin: "0 1rem" }, variant: "text", startIcon: React__default['default'].createElement(Icon$K, { color: "textSubtle", width: "24px" }) },
...
var templateObject_1$D, templateObject_2$c, templateObject_3$6, templateObject_4$2, templateObject_5$1, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { title: "#000000", navBar: "#FFFFFF", sideBar: "#FFFFFF", heading: "#7f00ff", background: "#FAF9FA", backgroundDisabled: "#E9EAEB", minibg: "/images/darkbg.png", lotterybg: "/images/whitelottery.png", contrast: "#191326", invertedContrast: "#FFFFFF", input: "linear-gradient(to right, #e0eafc, #cfdef3)", tertiary: "#EFF4F5", text: "linear-gradient(to right, #7f00ff, #e100ff)", textDisabled: "#BDC2C4", textSubtle: "#000", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { title: "#FFFFFF", navBar: "#27262c", sideBar: "#27262c", secondary: "#9A6AFF", background: "#000000", minibg: "/images/whitebg.png", lotterybg: "/images/blacklottery.png", heading: "linear-gradient(to right, #7f00ff, #e100ff)", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
