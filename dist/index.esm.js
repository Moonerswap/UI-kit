...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: isDark ? '/images/logoTextDark.svg' : '/images/logoTextLight.svg' })));
};
...
styled.a(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n\ncursor:pointer;\npadding: 0 1rem 0 1rem;\ncolor: ", ";\nfont-size: 1.3rem;\npadding: 1rem;  \n \n  "], ["\n\ncursor:pointer;\npadding: 0 1rem 0 1rem;\ncolor: ", ";\nfont-size: 1.3rem;\npadding: 1rem;  \n \n  "])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var T = styled(Text)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  cursor: pointer;\n  @-webkit-keyframes hvr-hang {\n    0% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    50% {\n      -webkit-transform: translateY(4px);\n      transform: translateY(4px);\n    }\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @keyframes hvr-hang {\n    0% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    50% {\n      -webkit-transform: translateY(4px);\n      transform: translateY(4px);\n    }\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @-webkit-keyframes hvr-hang-sink {\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @keyframes hvr-hang-sink {\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    \n    \n    \n      -webkit-transform: perspective(1px) translateZ(0);\n      transform: perspective(1px) translateZ(0);\n      box-shadow: 0 0 1px rgba(0, 0, 0, 0);\n      position: relative;\n      overflow: hidden;\n    \n    &:before {\n      content: \"\";\n      position: absolute;\n      z-index: -1;\n      left: 0;\n      right: 100%;\n      top: 0;\n      background: linear-gradient(to right, #bc4e9c, #f80759);\n      height: 4px;\n      -webkit-transition-property: right;\n      transition-property: right;\n      -webkit-transition-duration: 0.3s;\n      transition-duration: 0.3s;\n      -webkit-transition-timing-function: ease-out;\n      transition-timing-function: ease-out;\n    }\n    &:hover:before, &:focus:before, &:active:before {\n      right: 0;\n    }\n    \n    \n    \n    -webkit-transform: perspective(1px) translateZ(0);\n        transform: perspective(1px) translateZ(0);\n        box-shadow: 0 0 1px rgba(0, 0, 0, 0);\n        -webkit-transition-duration: 0.3s;\n        transition-duration: 0.3s;\n        -webkit-transition-property: transform;\n        transition-property: transform;\n      \n      &:hover, &:focus, &:active {\n        -webkit-transform: translateX(8px);\n        transform: translateX(8px);\n      }\n    \n"], ["\n  cursor: pointer;\n  @-webkit-keyframes hvr-hang {\n    0% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    50% {\n      -webkit-transform: translateY(4px);\n      transform: translateY(4px);\n    }\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @keyframes hvr-hang {\n    0% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    50% {\n      -webkit-transform: translateY(4px);\n      transform: translateY(4px);\n    }\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @-webkit-keyframes hvr-hang-sink {\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    @keyframes hvr-hang-sink {\n    100% {\n      -webkit-transform: translateY(8px);\n      transform: translateY(8px);\n    }\n    }\n    \n    \n    \n      -webkit-transform: perspective(1px) translateZ(0);\n      transform: perspective(1px) translateZ(0);\n      box-shadow: 0 0 1px rgba(0, 0, 0, 0);\n      position: relative;\n      overflow: hidden;\n    \n    &:before {\n      content: \"\";\n      position: absolute;\n      z-index: -1;\n      left: 0;\n      right: 100%;\n      top: 0;\n      background: linear-gradient(to right, #bc4e9c, #f80759);\n      height: 4px;\n      -webkit-transition-property: right;\n      transition-property: right;\n      -webkit-transition-duration: 0.3s;\n      transition-duration: 0.3s;\n      -webkit-transition-timing-function: ease-out;\n      transition-timing-function: ease-out;\n    }\n    &:hover:before, &:focus:before, &:active:before {\n      right: 0;\n    }\n    \n    \n    \n    -webkit-transform: perspective(1px) translateZ(0);\n        transform: perspective(1px) translateZ(0);\n        box-shadow: 0 0 1px rgba(0, 0, 0, 0);\n        -webkit-transition-duration: 0.3s;\n        transition-duration: 0.3s;\n        -webkit-transition-property: transform;\n        transition-property: transform;\n      \n      &:hover, &:focus, &:active {\n        -webkit-transform: translateX(8px);\n        transform: translateX(8px);\n      }\n    \n"])));
var Price = styled.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  \n"], ["\n  \n"])));
var PriceLink = styled.a(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var UpdatedFlex = styled(Flex)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  width: 20rem;\n  justify-content: space-between;\n  display: none;\n  margin-left: 0rem;\n  ", " {\n    display: flex;\n    margin-left: 2rem;\n  }\n"], ["\n  width: 20rem;\n  justify-content: space-between;\n  display: none;\n  margin-left: 0rem;\n  ", " {\n    display: flex;\n    margin-left: 2rem;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var UpdatedFlex2 = styled(Flex)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  justify-content: space-between;\n  display: none;\n  margin-left: 0rem;\n  ", " {\n    display: flex;\n    margin-left: 2rem;\n  }\n"], ["\n  justify-content: space-between;\n  display: none;\n  margin-left: 0rem;\n  ", " {\n    display: flex;\n    margin-left: 2rem;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(Flex, null,
                ...
                React.createElement(UpdatedFlex, { alignItems: "center" },
                    React.createElement(Dropdown, { target: React.createElement(T, null, "Trade") },
                        React.createElement(T, null, "Exchange"),
                        React.createElement(T, null, "Liquidity")),
                    React.createElement(T, null, "Farms"),
                    React.createElement(T, null, "Pools"),
                    React.createElement(T, null, "NFT"),
                    React.createElement(Dropdown, { target: React.createElement(T, null,
                            React.createElement(Icon$M, null)) },
                        React.createElement(T, null, "Bird Software"),
                        React.createElement(T, null, "Solution")))),
            React.createElement(Flex, { alignItems: "center" },
                React.createElement(Button, { style: { padding: "0rem 0.8rem", marginRight: "1rem" }, variant: "text", onClick: function () { return toggleTheme(!isDark); } },
                    React.createElement(Flex, { alignItems: "center" },
                        React.createElement(Icon$N, { color: isDark ? "textDisabled" : "text", width: "24px" }),
                        React.createElement(Text, { color: "textDisabled", mx: "4px" }, "/"),
                        React.createElement(Icon$L, { color: isDark ? "text" : "textDisabled", width: "24px" }))),
                React.createElement(UpdatedFlex2, { alignItems: "center" },
                    React.createElement(Price, null, cakePriceUsd ? (React.createElement(PriceLink, null,
                        "     ",
                    ...
                    React.createElement(Dropdown, { target: React.createElement(Button, { style: { padding: "0 0.5rem", margin: "0 1rem" }, variant: "text", startIcon: React.createElement(Icon$K, { color: "textSubtle", width: "24px" }) },
